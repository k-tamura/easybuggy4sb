...
Keycloak、MySQL、攻撃者のアプリと連携して起動する場合
    ...
    $ echo HOST=192.168.1.17 > .env # EasyBuggy Bootを実行するサーバーのIPアドレスを指定してください
    $ echo TZ=Asia/Tokyo >> .env # コンテナーの時刻のずれを無くすために追加してください
    $ docker compose up
...
:warning: **Java 8が必要です。Java 9以降では動作しません。**
